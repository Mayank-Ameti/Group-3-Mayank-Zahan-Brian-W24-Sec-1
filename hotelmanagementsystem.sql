...
create table employee(name varchar(25), age varchar(10), gender varchar(15),job varchar(30), salary varchar(15),phone varchar(15), email varchar(40) , ID varchar (30));
...
insert into department values('Kitchen and Production','540000');
